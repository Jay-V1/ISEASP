        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">ISEASP<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                      ...
                      <!-- <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                        ...
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='comaspany'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=company">How to Apply</a></li>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Vigan City, Ilocos Sur, Philippines</address>
          <p>
            <i class="icon-phone"></i> (123) 456-789 - 1255-12584 <br>
            <i class="icon-envelope-alt"></i> email@email.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <ul class="link-list">
            ...
            <li><a href="<?php echo web_root; ?>index.php?q=company">How to Apply</a></li>
      ...
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <ul class="link-list">
            <!-- <?php 
                  $sql = "SELECT * FROM `tblemployers` c,`tbljob` j WHERE c.`EMPLOYERID`=j.`COMPANYID`   ORDER BY DATEPOSTED DESC LIMIT 3" ;
                  $mydb->setQuery($sql);
                  $cur = $mydb->loadResultList();
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; ISEASP 2025 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
